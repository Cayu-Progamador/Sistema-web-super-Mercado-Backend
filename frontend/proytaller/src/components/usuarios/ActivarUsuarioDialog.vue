    ...
    <q-card class="dialog-card">
      ...
      <div class="dialog-header">
        <div class="header-left">
          <div class="warn-icon">
            <q-icon name="person_add" size="22px" style="color:#4a8c25" />
          </div>
          <div>
            <div class="dialog-title">Activar Usuario</div>
            <div class="dialog-sub">Esta acción restaurará el acceso al sistema</div>
          </div>
        </div>
      ...
      <q-card-section class="dialog-body">
        ...
        <div class="warn-box">
          <q-icon name="info" size="17px" style="color:#4a8c25;flex-shrink:0;margin-top:1px" />
          <p>Al activar este usuario, <strong>recuperará acceso inmediato</strong> al sistema con sus permisos y configuraciones previas.</p>
        </div>
        ...
        <div class="consecuencias">
          ...
          <div class="cons-list">
            <div class="cons-item">
              <span class="cons-dot"></span>Podrá iniciar sesión con sus credenciales
            </div>
            <div class="cons-item">
              <span class="cons-dot"></span>Recuperará todos sus permisos asignados
            </div>
            <div class="cons-item">
              <span class="cons-dot"></span>Sus datos y configuraciones se mantienen intactos
            </div>
            <div class="cons-item">
              <span class="cons-dot"></span>El rol y permisos quedarán restaurados
            </div>
          </div>
        </div>
        ...
        <div class="confirm-row" @click="confirmado = !confirmado">
          ...
          <span class="confirm-txt">Entiendo que el usuario recuperará acceso inmediatamente</span>
        </div>
      ...
      <div class="dialog-footer">
        ...
        >
          ...
          <q-icon v-else name="person_add" size="16px" />
          {{ cargando ? 'Activando...' : 'Activar Usuario' }}
        </button>
      </div>
...
.dialog-sub {
  font-size: 11px; font-weight: 600; color: #7aaa4e;
  font-family: 'Nunito', sans-serif;
}
.close-btn {
...
.warn-box p {
  font-size: 12.5px; font-weight: 600; color: #4a8c25;
...
.cons-dot {
  ...
  background: #82bd43; flex-shrink: 0;
}
...
.confirm-check {
  ...
  border: 2px solid #82bd43; background: #fff;
  display: flex; align-items: center; justify-content: center;
  flex-shrink: 0; transition: all 0.2s;
}
.confirm-check.checked { background: #82bd43; border-color: #82bd43; }
.confirm-txt {
  font-size: 12px; font-weight: 700; color: #4a8c25;
  font-family: 'Nunito', sans-serif;
}
...
.btn-activar:hover:not(.btn-disabled) {
